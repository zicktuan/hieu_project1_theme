...
class CustomPrimaryMenuWalker extends Walker_Nav_Menu {
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) 
    {
        ...
        $output .=  (is_object($args) && $args->has_children) ? $indent . '<li class="dropdown">' : $indent . '<li class="">';
        ...
        $attributes .= (is_object($args) && $args->has_children) ? ' class="dropdown-toggle" id="navbarDropdownMenuLink1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"' : '';
